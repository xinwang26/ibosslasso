...
for(i in 1:rounds)
{
  ...
  lasso_cor25 = reg_module("cor",r=25/p)
  convg = convg*(lasso_cor25$cvm_rch_min)
  ...
  row_cor25 = eval_module(lasso_cor25)
  ...
  repo_cor25 = rbind(repo_cor25,row_cor25)
