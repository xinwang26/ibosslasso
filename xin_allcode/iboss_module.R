...
#library(irlba)
source("implement_module.R",echo = T,max.deparse.length = 10000)
#library(irlba)
...
(scale_beta  = 2*sqrt(log(p)/subsize))#necessary for data generation
...
method_string = c("full","cor01","cor02","cor03","all","rand","lev")
output = data.frame()
