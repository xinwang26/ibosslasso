...
getIdx <- cxxfunction(signature(Rx="numeric", Rf="numeric",
                      ...
                      src, plugin = "Rcpp")
## when you call this function in your r code, Rx should be the vector to be sorted(all former selected removed) while Rf should be the original frame(without removing selected by former columns), this function will return the id in the original framework then
