...
(scale_beta  = sqrt(log(p)/1000)*1.2)#necessary for data generation

X_distribution = "fast_n"
data_gen = data_gen_cor_r
...
repo_clev01  = data.frame()
repo_calev01  = data.frame()
repo_lev  = data.frame()
...
while(i<rounds)
{
  ...
  lasso_clev01  = reg_module("clev",r=0.1)
  convg = convg*(lasso_clev01 $cvm_rch_min)
  lasso_calev01  = reg_module("calev",r=0.1)
  convg = convg*(lasso_calev01 $cvm_rch_min)
  ...
  if(convg==1){
    ...
    row_clev01  = eval_module(lasso_clev01 )
    row_calev01  = eval_module(lasso_calev01 )
    ...
    repo_clev01  = rbind(repo_clev01 ,row_clev01 )
    repo_calev01  = rbind(repo_calev01 ,row_calev01 )
  ...
  if(convg==0){
    ...
    rowi = c(i,
             ...
             lasso_clev01$cvm_rch_min,            
             lasso_calev01$cvm_rch_min,
