...
ifelse(exists("subsize")&(!is.na(subsize)),print(subsize),subsize<-1000)
setwd("/home/wjin3/code/tocopy")
.libPaths('/home/wjin3/code/lib')
library(data.table)
library(Metrics)
library(foreach)
#library(Rcpp)
...
saveRDS(rd_repo
        ,file=paste0(substr(datetime,1,5),"_n_",n,"_p_",p,"_k_",subsize,"_d_",X_distribution,"_full_out.rds"))
saveRDS(rd_record
        ,file=paste0(substr(datetime,1,5),"_n_",n,"_p_",p,"_k_",subsize,"_d_",X_distribution,"_full_record.rds"))
